...
delete_category = '🗑️ Kategoriyani oʻchirish'
...
async def process_add_product(message: Message):
    ...
    await message.answer('Ism?', reply_markup=markup)
...
@dp.callback_query_handler(IsAdmin(), product_cb.filter(action='o\'chirish'))
...
async def show_products(m, products, category_idx):
    ...
    for idx, title, body, image, price, tag in products:
        ...
        markup = InlineKeyboardMarkup()
        markup.add(InlineKeyboardButton(
            '🗑️ Oʻchirish', callback_data=product_cb.new(id=idx, action='o\'chirish')))
